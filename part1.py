...
class DCGenerator(nn.Module):
    def __init__(self, noise_size, conv_dim, spectral_norm=False, is_col=False):
        ...
        ###########################################
        # print(f"noise_size: {noise_size}")
        # print(f"conv_dim: {self.conv_dim}")
#         self.linear_bn = nn.BatchNorm2d(nn.Linear(in_features=self.noise_size, out_features=self.conv_dim*4*4*4))
    ...
    def forward(self, z):
        """Generates an image given a sample of random noise.
            ...
            Output
            ------
                out: BS x channels x image_width x image_height  -->  BSx1x32x32 (during training)
        """
        batch_size = z.size(0)
